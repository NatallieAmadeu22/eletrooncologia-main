    ...
    >
      ...
      >
        ...
        >
          <span>Usuário:</span>
          <span
            style={{ color: dark ? "#e2eaf4" : "#0d2137", fontWeight: 500 }}
          >
            admin@eletrooncologia.com
          </span>
        </div>
      ...
      >
        ...
        <form onSubmit={handleSubmit}>
          ...
          <button
            ...
            onMouseEnter={(e) => {
              if (!loading) e.target.style.opacity = ".88";
            }}
            onMouseLeave={(e) => {
              e.target.style.opacity = loading ? ".8" : "1";
            }}
          >
            {loading ? (
              <>
