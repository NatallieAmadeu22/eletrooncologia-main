...
export default function Dashboard() {
      ...
      setCounts({
        ...
        empresasParceiras:
          emp.status === "fulfilled"
            ? Array.isArray(emp.value.data?.empresas_parceiras)
              ? emp.value.data.empresas_parceiras.length
              : 0
            : 0,
      }),
    );
  ...
  const kpis = [
    ...
    },
    {
      ...
      value: counts.aplicacoes,
      icon: "bi-activity",
      color: "blue",
    },
    {
      label: "Clientes / Instituições",
    ...
    },
    {
      ...
      value: counts.parcerias,
      icon: "bi-diagram-3",
      color: "blue",
    },
    {
      label: "Empresas parceiras",
      value: counts.empresasParceiras,
      icon: "bi-buildings",
      color: "green",
    },
  ];
  ...
  return (
    <div>
      ...
      <div className="section-sub">
        ...
        Sistema Eletrooncologia — visão consolidada
      </div>
        ...
        <div className="col-lg-6">
          <div className="card-dark h-100">
            ...
            >
              ...
              é uma empresa brasileira de tecnologia médica focada em
              transformar o tratamento do câncer por meio do{" "}
              <strong style={{ color: "var(--clr-accent)" }}>Oncochip</strong>,
              dispositivo de micro-sensores que libera nanorrobôs no sistema
              sanguíneo para atuação direta no tratamento oncológico.
            </p>
          ...
          <div className="card-dark h-100">
            ...
            <div className="d-flex flex-column gap-3">
              {[
                {
                  icon: "bi-cpu-fill",
                  title: "Micro-Sensores",
                  desc: "Dispositivos de alta precisão integrados ao Oncochip para captura de dados em tempo real",
                },
                {
                  icon: "bi-robot",
                  title: "Nanorrobôs",
                  desc: "Liberados no sistema sanguíneo para atuação direta no tecido oncológico",
                },
                {
                  icon: "bi-graph-up-arrow",
                  title: "Diagnóstico Precoce",
                  desc: "Identificação antecipada e monitoramento contínuo do tratamento",
                },
              ].map((t) => (
